...
stock_prices = {"IBM": 0, "AAPL": 0, "FB": 0, "AMZN": 0, "GOOG": 0, "AVGO": 0,
                "VZ": 0, "INTC": 0, "AMD": 0, "MSFT": 0, "DELL": 0, "ORCL": 0}
...
while True:
    ...
    if (all(stock_acquired.values())):
        ...
        # Calculations
        current_eval_p1 = {"IBM": stock_prices["IBM"] * 1300, "AAPL": stock_prices["AAPL"] * 2200,
                           "FB": stock_prices["FB"] * 1900,
                           "AMZN": stock_prices["AMZN"] * 2500, "GOOG": stock_prices["GOOG"] * 1900,
                           "AVGO": stock_prices["AVGO"] * 2400}
        current_eval_p2 = {"INTC": stock_prices["INTC"] * 2600, "VZ": stock_prices["VZ"] * 2900,
                           "AMD": stock_prices["AMD"] * 2100,
                           "MSFT": stock_prices["MSFT"] * 1200, "DELL": stock_prices["DELL"] * 2700,
                           "ORCL": stock_prices["ORCL"] * 1200}
